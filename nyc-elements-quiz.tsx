        ...
        {sigilsFor(result).map(({ key, conf }, i) => {
          ...
          return (
            <div key={key} className="q-card">
              ...
              {openS && (
                <div id={"sigil-panel-" + key} role="region" aria-label={SG.name + " details"} className="px-5 pb-4">
        ...
        {days.map((d, i) => {
          ...
          return (
            <div key={i} className="relative pb-3 anim-up" style={{ paddingLeft: 60, animationDelay: (450 + i * 70) + "ms" }}>
              ...
              {open && (
                <div id={"day-panel-" + i} role="region" aria-label={"Day " + (i + 1) + ", " + H.name + " itinerary"} className="anim-up mt-2 px-5 py-4 flex flex-col gap-3.5" style={{ background: "#fff", border: "1.5px solid " + TEXT_SAFE[d.from] + "66", borderRadius: 16 }}>
